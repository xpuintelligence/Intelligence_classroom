  ...
  export default {
    ...
    async mounted() {
      ...
      for (let i = 0; i < this.thisSemesterTotalInfo.length; i++) {
        ...
        this.packedbubbleCharts.series[0].data.push(tmp);

        tmp.value = this.thisSemesterTotalInfo[i].attendScore;
        this.packedbubbleCharts.series[1].data.push(tmp);

        tmp.value = -this.thisSemesterTotalInfo[i].attendanceTotalScore;
        this.packedbubbleCharts.series[2].data.push(tmp);
      }
